...
const OUTBOUND_LABELS: Partial<Record<RelationshipType, (name: string) => string>> = {
  ...
  calls: (n) => `Calls ${n}`,
  uses: (n) => `Uses ${n}`,
  reads: (n) => `Reads from ${n}`,
  writes: (n) => `Writes to ${n}`,
  creates: (n) => `Creates ${n}`,
  updates: (n) => `Updates ${n}`,
  owns: (n) => `Owns ${n}`,
  belongs_to: (n) => `Belongs to ${n}`,
...
const INBOUND_LABELS: Partial<Record<RelationshipType, (name: string) => string>> = {
  ...
  uses: (n) => `Used by ${n}`,
  reads: (n) => `Read by ${n}`,
  writes: (n) => `Written by ${n}`,
  creates: (n) => `Created by ${n}`,
  updates: (n) => `Updated by ${n}`,
  owns: (n) => `Owned by ${n}`,
  belongs_to: (n) => `Includes ${n}`,
