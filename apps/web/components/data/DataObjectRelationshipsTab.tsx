...
const DATA_OBJECT_ACCENT = "#8b5cf6";
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-xs text-gray-400 mt-3">
          Domain, owner, and store placement are edited on the Details tab. Use Add or expand the map
          for other repository relationships.
        </p>
      </div>
    </div>
  );
